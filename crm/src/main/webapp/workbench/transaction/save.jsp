	...
	<script>
		...
		$(function (){
			...
			$("#create-stage").change(function () {
				...
				* 目标填写可能性
				* 阶段有了：stage
				* 阶段和可能性之间的对应关系：pMap，但是pMap是java语言中的键值对关系（java中的map对象）
				* 首先得将pMap转换为js中的键值对关系json
				*
				* 我们要做的是将pMap
				* 	pMap.put("01资质审查"，10)；
				* 	pMap.put("02需求分析"，25)；
				...
				* */
				...
				/*
					...
					因为今天的stage是一个可变的变量
					如果是这样的key，那么我们就不能以传统的json.key的形式来取值(以数字开头的key也不行)
					我们要使用的取值方式为
					json[key]
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="f15a94f07f364d74ae6723ce8930606b"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="56fb9a7d11b442a9bc7262adcd8bd0ba">
			</div>
		</div>
