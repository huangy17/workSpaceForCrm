	...
	<script type="text/javascript">
		$(function(){
					...
					$.ajax({
						...
						success : function (data) {
							...
							$.each(data,function (i,n) {
								html += '<tr>';
								html += '<td><input type="radio" name="xz" value="'+n.id+'" name="activity"/></td>';
			...
			$("#convertBtn").click(function (){
				/*
				* 提交请求到后台，执行线索转换的操作，应该发出传统请求，应为不涉及返回json使页面刷新
				* 请求结束后，最终响应回线索列表页
				*
				* 根据“为客户创建交易”的复选框有没有挑勾，来判断是否需要交易
				*
				* */
				if($("#isCreateTransaction").prop("checked")) {
					...
					//window.location.href= "workbench/clue/convert.do？clueId=${param.id}&money=xxx&expectedDate&";
					//以上传递参数的方式很麻烦，而且表单一旦扩充，挂在的参数有可能超出浏览器地址栏的上限
					//我们想到使用提交交易表单的形式来发出本次的传统请求
					//提交表单的参数不用手动挂（表单中写name属性），提交表单能够提交post请求（post请求中参数是已请求体的方式传递，没有上限。参数是不可见的，安全。）
