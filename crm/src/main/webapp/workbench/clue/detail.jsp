...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            //位关联市场模态窗口中的 搜索框 绑定事件，通过触发回车键，查询并展现所需市场活动列表
            $("#aname").keydown(function (event) {
                ...
                if(event.keyCode==13){
                    //alert("查询并展现市场活动列表");
                    $.ajax({
                        url : "workbench/clue/getActivityListByNameAndExcludeClueId.do",
                        data : {
                    ...
                    $.ajax({
                        ...
                        success : function (data) {
                            ...
                            if(data.success){
                                ...
                                //刷新关联的市场活动列表
                                showActivityList();
                                //清除搜索框的信息没，复选框中的勾取消，清空activitySearchBody中的内容
